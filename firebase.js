...
// Initialize Firebase
export {app,db,setDoc,getDocs, query, where,collection,addDoc,doc,getDoc,getAuth,signInWithEmailAndPassword,createUserWithEmailAndPassword,auth,sendPasswordResetEmail,signOut,onAuthStateChanged}
